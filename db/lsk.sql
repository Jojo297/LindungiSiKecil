...
(120, 'muhammad rozali', '2024-02-13', 'Laki-laki', 84, '2024-06-13 08:22:56', '2024-06-13 05:54:29'),
(121, 'muhammad sumbul', '2024-05-16', 'Laki-laki', 84, '2024-06-13 07:23:43', '2024-06-13 07:20:22');
...
(13, '1 bulan', 5, 35, 53, '2024-06-13 06:16:06', '2024-06-13 05:59:13', 120),
...
(16, '3 bulan', 5, 35, 53, '2024-06-13 07:04:02', '2024-06-13 07:04:02', 120),
(17, '4 bulan', 6, 59, 53, '2024-06-13 07:34:26', '2024-06-13 07:32:54', 120);
...
(208, 121, 206, 'belum', '2024-06-13 14:23:43', '2024-06-13 14:23:43'),
(209, 121, 207, 'belum', '2024-06-13 14:23:43', '2024-06-13 14:23:43'),
(210, 121, 208, 'belum', '2024-06-13 14:23:43', '2024-06-13 14:23:43'),
(211, 121, 209, 'belum', '2024-06-13 14:23:43', '2024-06-13 14:23:43'),
(212, 121, 214, 'belum', '2024-06-13 14:23:43', '2024-06-13 14:23:43'),
(215, 120, 208, 'sudah', '2024-06-13 07:36:17', '2024-06-13 14:32:31'),
(216, 120, 209, 'belum', '2024-06-13 14:32:31', '2024-06-13 14:32:31');
...
(34, '2024-06-13', 120, 208, '2024-06-13 07:36:17', '2024-06-13 07:36:17');
...
(206, 0, 1, '2024-06-12 13:17:20', '2024-06-03 09:00:49', 1),
...
(4, 'BCG', 'Imunisasi BCG berfungsi untuk mencegah penyakit tuberkulosis (TBC). Jadwal imunisasi BCG hanya satu kali, yaitu segera setelah lahir atau sebelum bayi berusia 1 bulan.\r\n\r\nJika imunisasi BCG tidak dapat diberikan setelah waktu tersebut, pemberiannya harus segera sebelum terpapar infeksi. ', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
(33, 'sdadsa', 'sadasda', 1, '2024-05-28 21:09:52', '2024-05-28 21:09:52');
...
(39, 'mafiffudin28@gmail.com', 'pipu', '$2y$12$lUkOrf54JuTbaJ0khytd8u4mHF9.Yz4P1ChTMcgl0L8/BMczneTte', 'eyJpdiI6IjZyN3J5bDVoNTgxTnU3MFJxVjYvWUE9PSIsInZhbHVlIjoiSlhOdFFiWStNZUdNeG9CWERPWURLQT09IiwibWFjIjoiNDliZTQ3YzQ2OGQ1ZTgxMGRjYjc4NmVlMzdiYzdjOTUwMTYxOWZlZmM4NTcwMjM0MmNmMmZhMjZkMzcwMjc1NCIsInRhZyI6IiJ9', 144933, '2024-05-30 11:25:36', '2024-05-27 09:45:59'),
(84, 'udin@gmail.com', 'udinfer', '$2y$12$LaWoDdE84BizmRu9VSHYKOzG5yPhJIAlksPd2d3hb34bbn2qbvmy2', 'eyJpdiI6IkRKWG14V0NUd1BnVVpUb0phU0k3Mnc9PSIsInZhbHVlIjoiTk42aXNCKzErRXdMWUVhem5QNEV0dz09IiwibWFjIjoiMTE5NzI0NGVkNWFmZjIzODlhMTczNjZiYTYxMjE4ZmRjNzFhOGI1ODE4ZGRiMTQ1YWY1ZDY3MDY0ZDU2NDRmNiIsInRhZyI6IiJ9', 697807, '2024-06-13 08:25:42', '2024-06-13 02:36:59');
...
(121, 'hepatitis B 2', 206, '2024-06-03 09:01:55', '2024-06-03 09:01:55'),
...
--
ALTER TABLE `child_growth`
  MODIFY `Id_growth` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `child_schedule`
--
ALTER TABLE `child_schedule`
  MODIFY `id_child_schedule` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=217;

--
-- AUTO_INCREMENT for table `history_imunization`
--
ALTER TABLE `history_imunization`
  MODIFY `id_history` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `immunization_schedule`
--
ALTER TABLE `immunization_schedule`
  MODIFY `id_schedule` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=222;

--
-- AUTO_INCREMENT for table `information_vaccine`
--
ALTER TABLE `information_vaccine`
  MODIFY `id_information` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `parents`
--
ALTER TABLE `parents`
  MODIFY `id_parent` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
...
--
ALTER TABLE `vaccines`
  MODIFY `id_vaccine` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;
